            ...
            <main className="group">
                ...
                <section className="item-double">
                    ...
                    <ul>
                        ...
                        <li>I love character design and creating comics in my free time. Check out my <a href="https://www.instagram.com/ollybaby.prod/" rel="noreferrer" target="_blank">Instagram</a>!</li>
                    </ul>
                </section>
                <div className="item">
